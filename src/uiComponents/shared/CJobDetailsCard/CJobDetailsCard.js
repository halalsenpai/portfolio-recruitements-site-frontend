...
import CJobsCarouselv2 from "../CJobsCarousel/CJobsCarouselv2";

function CJobDetailsCard({ jobs, showAllDetails = true }) {
  return (
      ...
      <div className="job-details-wrapper">
        <span className="details-header">
          ...
          <span className="actions-wrapper">
            ...
            <CButton themeColor="shadowed rounded">
              {" "}
          ...
          <span className="content-section">
            ...
            <span className="content-block">
              ...
              <ul className="c-list">
                ...
                <li>
                  m Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still
                  in their infancy. m Ipsum as their default model text, and a search for 'lorem ipsum' will uncover
                  many web sites still in their infancy.{" "}
                </li>
                <li>
                  arious versions have evolved over the years, sometimes by accident, sometimes on purpose (injected
                  humour and the like)
                </li>
              </ul>
            </span>
              ...
              <>
                <span className="content-block">
                  <h6 className="block-title">
                    About company: <mark className="ml-2 blue">Jobsmideast</mark>{" "}
                  </h6>

                  <p className="block-text">
                    Why do we use it? readable content of a page when looking at its layout. The point of using Lorem It
            ...
            <span className="content-box first">
              <span className="content-section">
                <span className="content-block">
                  ...
                  <div className="">
                    <CJobsCarouselv2 jobs={jobs.slice(0, 5)} />
