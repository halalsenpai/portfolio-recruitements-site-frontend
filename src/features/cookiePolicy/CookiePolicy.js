  ...
  return (
    <div className="user-guid-main">
      <div className="guid-wrapper">
        <div className="main-heading">COOKIE POLICY – JOBSMIDEAST.COM</div>
        <h3>Last updated [August 2021]</h3>
        <h1>INTRODUCTION</h1>
        <div>
          <p>
            Jobsmideast Ltd (“we” or “us” or “our”) may use cookies, web
            beacons, tracking pixels, and other tracking technologies when you
            visit our website Jobsmideast.com, including any othermedia form,
        ...
        <p>
          ...
          <div>
            <a href="">Android (Chrome)</a>
          </div>
          <div>
            <a href="">Blackberry</a>
          </div>
          <div>
            <a href="">Iphone or Ipad (Chrome)</a>
          </div>
          <div>
            <a href="">Iphone or Ipad (Safari)</a>
          </div>
        </p>
        <p>
          Other applications, social sites, websites, and other online platforms
          also come under this agreement.
        </p>
        <p>
          In addition, you may opt-out of some third-party cookies through the{" "}
          <a href="">Network Advertising Initiative’s Opt-Out Tool.</a>
        </p>
        ...
        <p>
          ...
          and acquire otherstatistical data. They collect only a limited set of
          data, such as a cookie number, time and date of page or email view,
          and a description of the page or email on which they reside.
          Webbeacons and pixel tags cannot be declined. However, you can limit
