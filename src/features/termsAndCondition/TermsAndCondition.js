...
import "./_termsandcondition.scss";

const TermsAndCondition = () => {
  return (
    <div className="user-guid-main">
      <div className="guid-wrapper">
        <div className="main-heading">TERMS OF USE</div>
        <h3>Last updated January 11, 2021</h3>
        <h1>AGREEMENT TO TERMS and using Jobsmideast.com</h1>
        <h3>Jobs Mid East Trademark No. UK00003558623</h3>
        <h3>
          Jobsmideast LTD (trading as Jobsmideast.com Company number 13283704)
        </h3>
        <h4>Registered company address</h4>
        <h2>Jobsmideast Ltd</h2>
        <h2>57 Southend Road,</h2>
        <h2>Grays, </h2>
        <h2>England,</h2>
        <h2>RM17 5NL</h2>
        ...
        <div>
          <p>
            ...
            logos contained therein (the “Marks”) are ownedor controlled by us
            ...
            our expressprior written permission.
          </p>
          <p>
          ...
          {/* <p>
            All of this information and more will be included in our email to
            you, if you need itagain.
          </p> */}
        </div>
        ...
        <p>
          By posting your Contributions to any part of the Siteor making
        ...
        <p>
          ...
          solely responsible for your Contributions to the Site andyou expressly
          agree to exonerate us from any and all responsibility and to
          refrainfrom any legal action against us regarding your Contributions.{" "}
        </p>
        <p>
          ...
          and for any reason, without notice. We haveno obligation to monitor
          your Contributions.
        </p>
        ...
        <p>
          ...
          should have first-hand experience with the person/entity being
        ...
        <p>
          ...
          or the views of any of our affiliatesor partners. We do not assume
        ...
        <p>
          ...
          such devices strictly in accordance withthe terms and conditions of
          ...
          rules, or regulations inconnection with your access or use of the
          ...
          generating endeavour, commercial enterprise, or other purpose for
          ...
          by multiple devices or users at the same time; (7) use the application
          for creating a product, service, or software that is, directly or
          indirectly, competitive with or in any way a substitutefor the
        ...
        <p>
          ...
          any of the termsand conditions that govern your use of the applicable
          ...
          available, and store (if applicable) any content that youhave provided
          ...
          submit to and receivefrom your Third-Party Account additional
          ...
          ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS ISGOVERNED SOLELY BY YOUR
        ...
        <p>
          ...
          for violationsof these Terms of Use; (2) take appropriate legal action
        ...
        <p>
          ...
          PARTICIPATION IN THE SITE OR DELETEYOUR ACCOUNT ANDANY CONTENT OR
        ...
        <p>
          ...
          oftheUnited Kingdom,and the use of the United Nations Convention of
          Contracts for the International Sale of Goods is expressly excluded.
          If your habitual residence isin the EU, and you are a consumer, you
          additionally possess the protection provided to you by obligatory
          provisions of the law of your country of residence.Jobsmideast Ltdand
          yourself both agree to submit to the non-exclusive jurisdiction of the
          courts ofUnited Kingdom and Wales, which means that you may make a
          claim to defend your consumer protection rights in regards to these
          Conditions of Use intheUnited Kingdom, or in the EU country in which
          you reside.
        </p>
        ...
        <p>
          ...
          expressly provided below) informally for at leastthirty (30)days
        ...
        <p>
          Any disputearising from the relationships between the Parties to this
          ...
          clause constitutes acceptance. The seat of arbitration shall beUnited
          Kingdom.The language of the proceedings shall beEnglish.Applicable
          rules of substantive law shall be the law oftheUnited Kingdom.
        </p>
        <h3>Restrictions</h3>
        <p>
          The Parties agree that any arbitration shall be limited to the Dispute
          between theParties individually. To the full extent permitted by law,
          (a) no arbitration shall bejoined with any other proceeding; (b) there
          ...
          there is no right or authority for any Dispute to be brought ina
        ...
        <p>
          ...
          TO THEFULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES,
          ...
          (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERSAND/OR ANY
          ...
          OR DAMAGE OF ANY KIND INCURRED AS A RESULTOF THE USE OF ANY CONTENT
          ...
          FEATURED IN ANY BANNER OR OTHERADVERTISING, AND WE WILL NOT BE A PARTY
        ...
        <p>
          ...
          USE OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY
          OFSUCH DAMAGES.NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED
          HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS
          OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TOTHE AMOUNT
          PAID, IF ANY, BY YOU TO USDURING THEONE (1)MONTH PERIOD PRIOR TO ANY
        ...
        <p>
          ...
          overt harmful act toward anyother user of the Site with whom you
          connected via the Site. Notwithstanding theforegoing, we reserve the
        ...
        <p>
          ...
          actionagainst us arising from any such loss or corruption of such
          data.
        </p>
        ...
        <p>
          ...
          OF TRANSACTIONS INITIATED OR COMPLETED BY US ORVIA THE SITE. You
        ...
        <p>
          ...
          waiver of such right or provision. TheseTerms of Use operate to the
          ...
          of these Terms of Use and the lack of signing by theparties hereto to
        ...
        <p>
          ...
          <a href="/">enquiries@jobsmideast.com</a>
        </p>
      </div>
    </div>
  );
