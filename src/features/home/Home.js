          ...
          <div className="row">
            <div className="padding-mobile col-lg-5 text-column pb-5 ">
              ...
              <span className="small-paragraph">
                ...
                <p>
                  Jobsmideast.com will be operating in Bahrain, Egypt, Kuwait, Oman, Qatar, Saudi Arabia & United Arab
                  Emirates providing the most advanced recruitment tools, communication systems and API capabilities
                  which will cater for 38 sectors and over 439 sub sectors.
                </p>
              </span>
