        ...
        <div className="row">
          <div className="col-lg-6 first-banner-heading-container">
            <span className="inner-container">
              ...
              <Fade bottom delay={500}>
                <h5 className="sub-heading color-text">Be the best. Find the best. Choose the best.</h5>
              </Fade>

              <Fade bottom delay={500}>
                <p className="mobile-textalign pr-4 mb-4">
                  We asked 97 companies, and 1000 job seekers what they struggle with when searching on job sites, and
                  we got the answers, so we built the smartest and the most advanced recruitment platform, free to use
              ...
              <Fade bottom delay={700}>
                <div>
                  ...
                  <p className="small-txt mobile-textalign">Join us for free. Launch date: June 2021.</p>
                </div>
              </Fade>
              {/* </div> */}
              {/* </Fade> */}
          ...
          <Fade bottom duration={1200} delay={300}>
            <div className="col-lg-6 p-0 margin-mobile">
              <CBannerWithImages className='c-banner-responsive' />
      ...
      <Fade bottom duration={1200}>
        <div>
          ...
          <div className="container-fluid p-0 d-flex justify-content-center">
            <img className="w-75 img-mobile" src={require("../../assets/images/home/1-homepage.png")} alt="" />
          </div>
        </div>
      </Fade>
      ...
      <Fade bottom duration={1200}>
        <div>
          <div className="c-container-centered-content small  mb-2">
            ...
            <h5 className="mobile-textalign">interviews, calls, connections and more.</h5>
          </div>
          <div className="space"></div>

          <div className="container-fluid p-0 d-flex justify-content-center">
            <img className="w-75 img-mobile" src={require("../../assets/images/home/8.png")} alt="" />
          </div>
        </div>
      </Fade>
      <div className="space"></div>
        ...
        <div className="row">
          <div className="padding-mobile col-lg-5 text-column pb-5 ">
            ...
            <span className="small-paragraph">
              <p>
                Jobsmideast.com is the most advanced job platform in the Middle East. We understand the problems
                individuals face on daily basis when searching for the right role, or finding the suitable candidate to
                join their team, and we are forever changing the way employers, job seekers & agencies connect.
              </p>

              <p>
                Our creative team consists of some of the most talented and experienced web developers, recruitment
                consultants, social media specialists and client account managers to make your Jobsmideast experience
                efficient, effortless and enjoyable. Client service is at the heart of our operation and it’s our number
                1 priority here at Jobsmideast.
              </p>

              <p>
                Jobsmideast.com will be operating in Bahrain, Egypt, Jordan, Kuwait, Oman, Qatar, Saudi Arabia, United
                Arab Emirates & Yemen, providing the most advanced recruitment tools, communication systems and API
                capabilities which will cater for 38 sectors and over 439 sub sectors.
              </p>
            </span>
            <CButton className="mt-2" themeColor="blue">
              <a className='book-a-demo-btn' href="https://calendly.com/jobsmideast/demo?month=2021-04&back=1">Book a Demo</a>
            </CButton>
          </div>
