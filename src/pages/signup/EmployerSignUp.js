      ...
      <div className="signup-container with-form">
        <Form className="c-form second-container align-items-start" onFinish={onFinish}>
          ...
          <Form.Item name="remember" className="mb-0">
            <Checkbox value="">
              I agree with Jobsmideast.com <mark className="blue">terms & conditions</mark> and{" "}
              <mark className="blue">privacy policy.</mark> and I agree to receive future emails, texts and
              communications.{" "}
            </Checkbox>
          </Form.Item>
